...
import { Sparkles, BookOpen, FileText, Mic, Brain, StickyNote, Bell } from "lucide-react";

const actions = [
  { title: "AI Answer Generator", desc: "VTU-aware exam answers", icon: Sparkles, color: "bg-blue-100 text-blue-600", path: "/ai-answer" },
  { title: "Subjects", desc: "Browse VTU syllabus", icon: BookOpen, color: "bg-purple-100 text-purple-600", path: "/subjects" },
  { title: "Previous Papers", desc: "1400+ official VTU papers", icon: FileText, color: "bg-green-100 text-green-600", path: "/papers" },
  { title: "VTU Updates", desc: "Timetables & circulars", icon: Bell, color: "bg-red-100 text-red-600", path: "/updates" },
